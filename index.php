...
<body>
	...
	<div>
	<img class="appLogo" style="margin-left:38.5%; margin-bottom:-0.5%;" src="img/LogoTest.png">
	</div>
	...
	<section class="main">
			...
			<form class="form-1" style="margin-left:40%;" action="loginAuth.php" method="POST">
				<p class="field">
