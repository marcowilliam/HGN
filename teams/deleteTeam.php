...
$sqlManager = "UPDATE user SET user_type_id = 4 WHERE user_id = {$team_manager} AND user_type_id <> 1 AND user_type_id <> 2";
$resultManager = mysqli_query($conn, $sqlManager);

$sql2 = "UPDATE team SET visibility = 0 WHERE team_id = {$team_id}";
