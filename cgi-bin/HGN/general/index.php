...
<body>				
	...
	<content>
		...
		<article class="rightArt" id="General">
			...
			<form action="changeGeneral.php" method="post" id="changeGeneral">
			...
			<table>
				<tr>
  				...
  				<tr>
						...
						<td class="wrapper"> 
	  						<input type="text" id="datepicker" name="dob_new" onkeypress="formatar_mascara(this, '####-##-##')" value="<?php echo $user_dob; ?>">
	  					</td>
  				</tr>
