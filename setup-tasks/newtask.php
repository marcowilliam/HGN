...
<body>				
	...
	<content>
		...
		<article class="rightArt" id="addTeam">
			<form action="addTask.php" method="post" id="addTaskForm" name="addTask">
			<table>
				<tr>
						<td> Task Name </td>
						<td> <input type="text" class="wrapper" name="task_name" value="<?php echo $task_name; ?>"> </td>
					</tr>
					...
					<tr>
						...
						<td> <textarea class="wrapper" rows=4 name="task_description"> </textarea>
					</tr>
					...
					<tr>
						...
						<td> 
							...
							<select name="task_visibility">
								<option value=1 <?php if ($task_visibility == 1) { echo "selected"; } ?>> Visible </option> 
								<option value=0 <?php if ($task_visibility == 0) { echo "selected"; } ?>> Invisible </option> 
							</select>
							</div>
						</td>
					</tr>
		...
		<table id="tabela_submit" class="high_table">
			...
			<tr onclick="document.getElementById('addTaskForm').submit()">
